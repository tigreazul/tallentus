    ...
    <header id="topbar">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="crumb-trail">Postulaciones</li>
            </ol>
        </div>
    </header>
    <!-- End: Topbar -->
                            ...
                            <tbody>
                                ...
                                <?php if (!empty($empresa)) : ?>
                                    <?php foreach ($empresa as $emp): ?>
                                        <tr>
                                            <td><?php echo $emp->postu_id; ?></td>
                                            <td><?php echo $emp->postu_titulo; ?></td>
                                            <td><?php echo strtoupper($emp->emp_razon_social); ?></td>
                                            <td><?php echo $emp->emp_fecha_creacion; ?></td>
                                            <td>
                                                <!-- <span class="modi">
                                                ...
                                                <span class="dele">
                                                    <a onclick="deleteDato(<?php echo $emp->postu_id; ?>);" href="#">
...
<script>
    function deleteDato(id) {
        ...
        if (r == true) {
            location.href = "<?php echo base_url().'usuario/postulaciones/delete/' ?>"+id;
        }
        return false;
    }
</script>