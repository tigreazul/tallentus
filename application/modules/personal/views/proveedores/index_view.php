<section id="content_wrapper">
    ...
    <header id="topbar">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="crumb-trail">Proveedor</li>
            </ol>
        </div>
    </header>
    <!-- End: Topbar -->
    ...
    <div id="content">
        ...
        <div class="row mt20 text-center bn10">
            <div class="col-xs-2">
                <a href="<?php echo base_url().'personal/proveedores/add' ?>" title="" class="btn active btn-warning btn-block">AGREGAR</a>
            </div>
        </div>
                ...
                <div class="panel panel-visible">
                    <div class="panel-heading">
                        <div class="panel-title hidden-xs">
                            <span class="glyphicon glyphicon-tasks"></span>Lista de Proveedores</div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="datatable2" cellspacing="0" width="100%">
                            ...
                            <tbody> 
                                <?php if (!empty($proveedor)) : ?>
                                    <?php foreach ($proveedor as $perso): ?>
                                        <tr>
                                            <td><?php echo $perso->idProveedor; ?></td>
                                            <td>
                                                <?php 
                                            ...
                                            <td>
                                                <span class="modi">
                                                    <a href="<?php echo base_url().'personal/proveedores/edit/'.$perso->idProveedor; ?>" title="" style="padding: 10px">
                                                        <span class="imoon imoon-pencil"></span>
                                                    </a>
                                                </span>
                                                
                                                <span class="dele">
                                                    <a onclick="deleteDato(<?php echo $perso->idProveedor; ?>);" href="#">
...
<script>
    function deleteDato(id) {
        ...
        if (r == true) {
            location.href = "<?php echo base_url().'personal/proveedores/delete/' ?>"+id;
        }
        return false;
    }
</script>