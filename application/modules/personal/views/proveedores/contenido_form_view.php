    ...
    <header id="topbar">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="crumb-link">
                    <a href="<?php echo base_url().'personal/proveedores' ?>">Proveedor</a>
                </li>
                <li class="crumb-trail"><?php echo $form['idProveedor'] == '' ? 'add' : 'edit' ?></li>
            </ol>
        </div>
    </header>
    <!-- End: Topbar -->
                ...
                <div class="admin-form">
                    ...
                    <div id="p1" class="panel heading-border">
                        ...
                        <div class="panel-body bg-light">
                            <?php echo form_open_multipart('personal/proveedores/cu_create_proveedores','class="form-ui" id="formulario_user"');?>
                                        ...
                                        <div class="col-md-10">
                                            <div class="section">
                                                <label class="field">
                                                    ...
                                                    <?php echo form_hidden('idu', $form['idProveedor']);?>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt20 text-center bn10">
                                    ...
                                    <div class="col-xs-2">
                                        <button type="submit" class="btn active btn-primary btn-block">
                                            <?php echo $form['idProveedor'] == '' ? 'GUARDAR' : 'ACTUALIZAR' ?>
                                        </button>
                                    </div>
                                </div>
